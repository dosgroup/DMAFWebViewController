...
-(id)initWithURL:(NSURL *)url {
    ...
    self.loadingPage = [NSString stringWithFormat:@"<html><body style=\"text-align: center; font-family: helvetica,arial,verdana,sans-serif;\"><br><br><br><br><img src=\"%@\"><br><br><br><br><h3><a href=\"webview://back\" style=\"color: #888;\">Cancel</a></h3></body></html>", LOADING_GIF];
